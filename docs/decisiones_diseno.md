...
- **Por qué este y no otro:** la decisión de inversión necesita las dos dimensiones **a la vez**. Un ranking por nota recomendaría histórico y bélico, que tienen las mejores notas entre las películas con datos financieros (6,92 y 6,85) y los peores retornos (1,16× y 1,27×). Un ranking por ROI recomendaría terror, que tiene la peor nota. Solo el cruce separa "prestigio de catálogo" de "caso de negocio".
